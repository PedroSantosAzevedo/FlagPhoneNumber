...
open class FPNTextField: UITextField {
    ...
    private var leftViewSize: CGSize {
        let width = flagButtonSize.width + getWidth(text: phoneCodeTextField.text! ) + leftPadding
    ...
    @objc open var codeText: String? = nil {
        didSet {
            if codeText != nil {
                self.phoneCodeTextField.text = codeText
            }
    ...
    @objc open var leadingPadding:CGFloat = 0 {
        didSet {
                self.leftPadding = leadingPadding
            setupLeftView()
            updateConstraints()
            layoutIfNeeded()
        }
    ...
    private func setupLeftView() {
        ...
        NSLayoutConstraint(item: flagButton, attribute: .leading, relatedBy: .equal, toItem: leftView, attribute: .leading, multiplier: 1, constant: leftPadding).isActive = true
        ...
        NSLayoutConstraint(item: phoneCodeTextField, attribute: .trailing, relatedBy: .equal, toItem: leftView, attribute: .trailing, multiplier: 1, constant:leftPadding).isActive = true
